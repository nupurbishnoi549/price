...
const TimelineSection = () => {
  ...
  return (
    <section id="timeline" ref={sectionRef} className="py-20 px-6">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300">A timeline of memories that make my heart skip a beat</p>
        </div>
        ...
        <div className="relative">
          ...
          {memories.map((memory, index) => (
            ...
            >
              {/* Timeline Dot */}
              <div className="absolute left-1/2 transform -translate-x-1/2 w-6 h-6 bg-white rounded-full border-4 border-pink-400 z-10 animate-pulse"></div>

              {/* Content Card */}
              <div className={`w-5/12 ${index % 2 === 0 ? 'pr-8' : 'pl-8'}`}>
                <div
                  className={`backdrop-blur-lg bg-white/10 rounded-2xl p-6 border border-white/20 shadow-2xl transform transition-all duration-700 hover:scale-105 ${
